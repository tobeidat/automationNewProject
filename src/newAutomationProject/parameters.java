...
public class parameters {
	...
	public void loginFunction(WebElement userName, WebElement userPassword) throws InterruptedException, IOException {
		WebElement userNameElement = userName;
		WebElement userPasswordElement = userPassword;
